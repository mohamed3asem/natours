...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(data, url, method, message) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function updateUserDate(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateUserDate = updateUserDate;
...
var stripe = Stripe('pk_test_zxQ98SvhhSlTstCf5sY06w5k00VUN0ykId');
...
var resetPassBtn = document.getElementById('reset_password_btn');
var forgetPassBtn = document.getElementById('forget-password-btn');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateUserData.updateUserDate)(form, 'updateMe', 'PATCH', 'Data updated successfully');
  });
}

if (updatePassForm) {
  updatePassForm.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateUserData.updateUserDate)({
                currentPassword: currentPassword,
                newPassword: newPassword,
                newPasswordConfirm: newPasswordConfirm
              }, 'updatePassword', 'PATCH', 'Password updates successfully');
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              password = document.getElementById('rest_password').value;
              passwordConfirm = document.getElementById('reset_password_confirm').value;
              _context2.next = 6;
              return (0, _updateUserData.updateUserDate)({
                password: password,
                passwordConfirm: passwordConfirm
              }, "resetPassword/".concat(token), 'PATCH', 'Password updated successfully');
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return (0, _updateUserData.updateUserDate)({
                email: email
              }, 'forgotPassword', 'POST', 'Email sent successfully. please check your email to reset password');
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              name = document.getElementById('sigup-name').value;
              ...
              return (0, _updateUserData.updateUserDate)({
                ...
                password: password,
                passwordConfirm: passwordConfirm
              }, 'signup', 'POST', "Welcome ".concat(name, " to natours family"));
